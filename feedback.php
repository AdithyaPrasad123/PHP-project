...
else
{
  if(isset($_POST['submit']))
  {
      ...
      $sql=mysqli_query($conn,"INSERT INTO `feedback`(candidate_id,feedback) VALUES ('$id','$feedback')");
  
  
      if ($sql) {
          echo '<script>alert("Feedback Uploades"); window.location.href="candidate_home.php";</script>';
         } else {
  ...
  <div class="container"> 
    ...
    <div class="row">
      ...
      <form method="POST" class="bg-primary-subtle p-3">
                    <textarea name="feedback" id="feedback" cols="70" rows="6" placeholder="Enter your Feedback here!"></textarea><br><br>
                    <input type="submit" name="submit" value="SUBMIT" class="btn btn-secondary" style="margin-left: 500px;">
                </form>
