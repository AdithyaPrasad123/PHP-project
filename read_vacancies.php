          ...
          <table class="table table-bordered table ">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo isset($row['job_name']) ? $row['job_name'] : ''; ?></td>
                <td><?php echo isset($row['location']) ? $row['location'] : ''; ?></td>
                <td><?php echo isset($row['qulification']) ? $row['qulification'] : ''; ?></td>
                <td><?php echo isset($row['salary_scale']) ? $row['salary_scale'] : ''; ?></td>
                <td><?php echo isset($row['job_type']) ? $row['job_type'] : ''; ?></td>
                <td><?php echo isset($row['experience']) ? $row['experience'] : ''; ?></td>
