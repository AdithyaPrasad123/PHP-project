...
<?php
  ...
  $sql2 = mysqli_query($conn, "SELECT * FROM `schedules` WHERE candidate_id= '$candidate_id'");
...
<section id="sss">
  ...
  <div class="container"> 
    <h1 style="color: #222222; font-family: sans-serif;" ><b>Welcome to </b><spa style="color: #106eea;">IT_JPS</span></h1><br>
      <h2><u>Send Notification!</u></h2><br>
    <div class="row">
      <div class="col-4">
      
      <form method="POST" action="send_notification.php?cid=<?php echo $candidate_id ?>" class="bg-primary-subtle p-3">
      ...
      <input type="text" name="place" class="form-control" value="<?php echo $row["place"]; ?>"><br>
      
                    <input type="submit" name="submit" value="SEND" class="btn btn-secondary" style="margin-left: 300px;">
                </form>
