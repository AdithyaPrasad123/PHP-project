  ...
  <div class="container"> 
    ...
    <div class="row">
      ...
      <?php while($row=mysqli_fetch_assoc($sql))
            { ?>
                    <!-- <input type="varchar" name="candidate_id" id="candidate_id" class="form-control" value="<?php echo $row["candidate_id"]; ?>"><br>
                    <textarea name="feedback" id="feedback" cols="70" rows="6" value="<?php echo $row["feedback"]; ?>"></textarea><br><br>
                    <input type="submit" name="submit" value="SUBMIT" class="btn btn-secondary" style="margin-left: 500px;"> -->
                    <table class="table boarded-table">
                      <thead>
                        <th>Candidate Id</th>
                        <th>Feedback</th>
                      </thead>
