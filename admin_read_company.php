...
<section id="sss">
  <div class="container"> 
    ...
    <h2><u>Companies Registered</u></h2><br>
    <div class="container">
      <div class="row">
        <div class="col-4">
          <form method="POST">
                ...
                <?php while($row=mysqli_fetch_assoc($sql))
                  { ?>
                    <tr>
                      ...
                      <td><a href="approve.php?id=<?php echo $row['company_id']; ?>" class="btn btn-primary" name="approve">Approve</a></td>
                      <td><a href="reject.php?id=<?php echo $row['company_id']; ?>" class="btn btn-danger" name="reject">Reject</a></td>
                    </tr><?php
                  } ?>
              </tbody>
            </table>
