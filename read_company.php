        ...
        <?php while($row=mysqli_fetch_assoc($sql))
            { ?>
                <tr>
                    ...
                    <td><a href="approve.php?id=<?php echo $row['id']; ?>" class="btn btn-primary" name="approve">Approve</a></td>
                    <td><a href="reject.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" name="reject">Reject</a></td>
