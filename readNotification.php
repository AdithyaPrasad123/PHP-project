...
if (!isset($_SESSION['id'])) {
    ...
    $id = $_SESSION["id"];
    $join = mysqli_query($conn, "SELECT companies.company_name,notification.date,notification.time,notification.place FROM `companies` 
        INNER JOIN `applications` ON companies.company_id=applications.company_id 
        INNER JOIN `notification` ON applications.candidate_id=notification.candidate_id 
        WHERE notification.candidate_id='$id'");
...
<body>
  ...
  <section id="sss">
       ...
       <?php
                            ...
                            echo "<p>No notifications found for this candidate.</p>";
                        }
                        ?>
                    </form>
                </div>
